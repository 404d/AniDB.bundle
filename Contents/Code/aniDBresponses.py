...
class Response:
    ...
    def parse(self):
        ...
        self.attrs = self.toMap(self.codehead, tmp[:-1])
        self.resstr = tmp[-1]
    ...
    def toMap(self, seq1, seq2):
        result = {}
        index = 0
        for item in seq1:
            result[item] = seq2[index]
            index = index + 1
        return result
...
class MylistResponse(Response):
    def __init__(self, cmd, restag, rescode, resstr, datalines):
        ...
        self.codestr = 'MYLIST'
        self.codehead = ()
        self.codetail = ('lid', 'fid', 'eid', 'aid', 'gid', 'date', 'state',
                         'viewdate', 'storage', 'source', 'other')
        self.coderep = ()
...
class MylistStatsResponse(Response):
    def __init__(self, cmd, restag, rescode, resstr, datalines):
        ...
        self.codehead = ()
        self.codetail = ('animes', 'eps', 'files', 'filesizes', 'animesadded',
                         'epsadded', 'filesadded', 'groupsadded', 'leechperc',
                         'lameperc', 'viewedofdb', 'mylistofdb',
                         'viewedofmylist', 'viewedeps', 'votes', 'reviews')
        self.coderep = ()
...
class AnimeDescResponse(Response):
    def __init__(self, cmd, restag, rescode, resstr, datalines):

        Response.__init__(self, cmd, restag, rescode, resstr, datalines)
        self.codestr = 'ANIMEDESC'
        self.codehead = ()
        self.codetail = ('current_part', 'max_parts', 'description')
        self.coderep = ()
...
class EpisodeResponse(Response):
    def __init__(self, cmd, restag, rescode, resstr, datalines):
        ...
        self.codehead = ()
        self.codetail = ('eid', 'aid', 'length', 'rating', 'votes', 'epno',
...
class ProducerResponse(Response):
    def __init__(self, cmd, restag, rescode, resstr, datalines):
        ...
        self.codehead = ()
        self.codetail = ('pid', 'name', 'shortname', 'othername', 'type',
                         'pic', 'url')
        self.coderep = ()
...
class GroupResponse(Response):
    def __init__(self, cmd, restag, rescode, resstr, datalines):
        ...
        self.codestr = 'GROUP'
        self.codehead = ()
        self.codetail = ('gid', 'rating', 'votes', 'animes', 'files', 'name',
...
class GroupstatusResponse(Response):
    def __init__(self, cmd, restag, rescode, resstr, datalines):
        ...
        self.codehead = ()
        self.codetail = ('gid', 'name', 'state', ' last_episode_number',
                         'rating', 'votes', 'episode_range')
        self.coderep = ()
...
class NotifygetMessageResponse(Response):
    def __init__(self, cmd, restag, rescode, resstr, datalines):
        ...
        self.codehead = ()
        self.codetail = ('nid', 'uid', 'uname', 'date', 'type', 'title',
                         'body')
        self.coderep = ()
...
class MultipleMylistEntriesResponse(Response):
    def __init__(self, cmd, restag, rescode, resstr, datalines):
        ...
        self.codehead = ()
        self.codetail = ('name', 'eps', 'unknowneps', 'hddeps', 'cdeps',
                         'deletedeps', 'watchedeps')
