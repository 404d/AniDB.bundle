...
class TvDBMap(object):
    ...
    def get_tvdb_for_anidb(self, anidb_id):
        return self.get_x_for_y(anidb_id, "anidbid", "tvdbid")

    def get_anidb_for_tvdb(self, tvdb_id):
        return self.get_x_for_y(tvdb_id, "tvdbid", "anidbid")

    def get_x_for_y(self, xValue, x, y):
    ...
    def get_season_episode_for_anidb_absoluteNumber(self, anidb_id,
                                                    absoluteNumber):
        # NOTE: this cant be done without the length of each season from
        # thetvdb
        # TODO: implement
        season = 0
        episode = 0
    ...
    def get_season_episode_for_tvdb_absoluteNumber(self, anidb_id,
                                                   absoluteNumber):
        # TODO: implement
        season = 0
        episode = 0
